...
function TodoList({ todos }) {
    ...
    const elements = todos.map((todo, index) =>
        <li className="todo-list list-group-item list-group-item-action d-flex align-items-center shadow-sm"
            key={index}
            style={todo.done ? style : null}>
            ...
            <div className="ml-auto btn-group">
                ...
                <Button className={classNames('btn', {
                    'btn-outline-warning': !todo.important,
                    'btn-warning': todo.important
                })}>
