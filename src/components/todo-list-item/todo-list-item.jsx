...
function TodoListItem({ done, label, important = false }) {
    const style = { textDecoration: 'line-through' };
    return (
        <div
            style={done ? style : null}
            className={classNames('todo-list-item d-flex align-items-center', { 'text-warning font-weight-bold': important })}>
            {label}
